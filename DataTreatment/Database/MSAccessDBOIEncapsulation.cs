...
namespace Cabinink.DataTreatment.Database
{
   ...
   [Serializable]
   [ComVisible(true)]
   public class MSAccessDBOIEncapsulation : IDatabasesOperationBase
   {
      ...
      public MSAccessDBOIEncapsulation(string dbConnectionString)
      {
      ...
      public MSAccessDBOIEncapsulation(Uri dbFileUrl)
      {
